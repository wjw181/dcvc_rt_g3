...
def parse_args(argv):
    ...
    parser.add_argument("-m", "--model", default="DMC_WJW", choices=["DMC"], help="Model architecture")
    parser.add_argument("-td", "--test_dataset", type=str, default="/home/serverdn/hdd-0/slf_data/data/testdata/HEVC_E/Johnny_1280x720_60/", help="Training dataset path")
    parser.add_argument("-td_l", "--test_filelist", type=str, default="/home/serverdn/hdd-0/slf_data/data/testdata/HEVC_E/test.txt", help="Training dataset path")
    parser.add_argument("-e", "--epochs", default=120, type=int, help="Number of epochs")
    parser.add_argument("-lr", "--learning-rate", default=1e-4, type=float, help="Learning rate")
    parser.add_argument("-n", "--num-workers", type=int, default=4, help="Number of dataloader threads")
    parser.add_argument("-q", "--quality-level", type=int, default=1, help="Quality level")
    ...
    # Accept both `--local-rank` and `--local_rank` to be compatible
    # with torch.distributed.launch / torchrun which may pass either form.
    parser.add_argument('--local-rank', '--local_rank', dest='local_rank', default=-1, type=int, help='node rank for distributed training')
    ...
    parser.add_argument("--manyframe_epoch", type=int, default=250, help="Epoch threshold to switch to 7-frame training")
