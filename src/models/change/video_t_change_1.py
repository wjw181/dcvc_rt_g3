...
class DMC(CompressionModel):
    ...
    def forward(self, x, qp):
        ...
        # y = y * y_mask_channel
        # print(ctx_t.min(), ctx_t.max())
        # print(z_hat.min(), z_hat.max())
        # print(params_1.min(), params_1.max())
        # print(y.max(), y.min())
        # print(y_mask.max(), y_mask.min())
        # print(y_channel_params.max(), y_channel_params.min())
